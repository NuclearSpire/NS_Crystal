...
using BaseLib.Utils;
using NS_Crystal.NS_CrystalCode.Character;
...
/// </summary>
[Pool(typeof(CrystalCardPool))]
public abstract class CrystalCard(int cost, CardType type, CardRarity rarity, TargetType target) :
